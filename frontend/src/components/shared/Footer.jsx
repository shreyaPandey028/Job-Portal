...
const Footer = () => {
  return (
    <footer className='bg-gradient-to-r from-slate-900 to-slate-800 border-t border-teal-500/30 py-8'>
      <div className='container mx-auto px-4'>
        <div className='max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4'>
          ...
          <div className='flex space-x-6 mt-4 md:mt-0'>
            <a href="https://facebook.com" className='text-slate-400 hover:text-teal-400 transition-colors' aria-label="Facebook">
            ...
            <a href="https://twitter.com" className='text-slate-400 hover:text-teal-400 transition-colors' aria-label="Twitter">
            ...
            <a href="https://linkedin.com" className='text-slate-400 hover:text-teal-400 transition-colors' aria-label="LinkedIn">
